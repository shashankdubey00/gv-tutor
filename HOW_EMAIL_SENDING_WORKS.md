...
- **YOUR Email (Sender):** `admin@gvtutor.com` ← **You need this account**
- **User's Email (Receiver):** `user@example.com` ← User receives email here
...
2. **Generate App Password**
   ...
   - Select "Mail" → "Other (Custom name)" → "GV Tutor"
   - Click "Generate"
...
## 🔍 What Email Address Sends the Emails?
...
### ❌ "I don't need an email account"
**✅ WRONG** - You absolutely need your own email account to send emails

### ❌ "I can use any email"
**✅ WRONG** - You need access to the account to generate App Password

### ❌ "I can use my regular password"
**✅ WRONG** - Must use App Password for Gmail

### ❌ "The system creates an email automatically"
**✅ WRONG** - You must provide your own email account
