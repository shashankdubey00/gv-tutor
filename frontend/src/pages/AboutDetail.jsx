    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#fffdf7_0%,#f7fbff_38%,#fff8fb_100%)] pt-28 text-slate-900">
      ...
      <div className="mx-auto max-w-7xl space-y-10 px-4 pb-20">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2rem] border border-cyan-200/80 bg-gradient-to-br from-white via-cyan-50/70 to-fuchsia-50/60 p-6 shadow-[0_24px_80px_rgba(14,165,233,0.10)] sm:p-8">
        ...
        <section className="rounded-[2rem] border border-cyan-200/80 bg-gradient-to-br from-white via-cyan-50/60 to-fuchsia-50/60 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] sm:p-8">
