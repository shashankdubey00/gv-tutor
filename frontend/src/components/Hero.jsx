...
const Hero = () => {
  ...
  return (
    <div className="bg-[#05070a] text-white selection:bg-blue-500/30">
      ...
      {/* PROFESSIONAL FOOTER */}
      <footer className="relative overflow-hidden bg-gradient-to-br from-gray-950 via-black to-slate-950 border-t border-cyan-500/20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <div className="rounded-[calc(2rem-1.5px)] bg-[rgba(5,9,15,0.88)] backdrop-blur-xl px-5 py-8 sm:px-8 sm:py-10">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="col-span-1 md:col-span-2">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">Goodwill Group of Education</h3>
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="w-11 h-11 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-11 h-11 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-11 h-11 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform duration-300 shadow-lg"
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><a href="/" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">Home</a></li>
                    <li><a href="/about" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">About Us</a></li>
                    <li><a href="/library" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300">Library</a></li>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
                      ...
                      <span className="text-gray-300 text-sm">goodwill2404@gmail.com</span>
                    </div>
                    <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
                      <div className="w-8 h-8 bg-cyan-500/20 rounded-full flex items-center justify-center">
                        <svg className="w-4 h-4 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-gray-300 text-sm">+91 9691569239</span>
                    </div>
                    <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-3">
                      <div className="w-8 h-8 bg-cyan-500/20 rounded-full flex items-center justify-center">
                        <svg className="w-4 h-4 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
